...
# Load the TSV file
file_path = "modified_CRISPR_phage_matches.tsv"
...
cleaned_data.to_csv("04_cleaned_matches.tsv", sep='\t', index=False)

print("Duplicates removed based on e-value. Cleaned data saved to 'cleaned_matches.tsv'.")
